...
-- Create Student Login Logs Table
CREATE TABLE IF NOT EXISTS public.student_login_logs (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE POLICY "Allow public access to system_audit_logs" ON public.system_audit_logs FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow public access to feedback_reports" ON public.feedback_reports FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow public access to student_login_logs" ON public.student_login_logs FOR ALL USING (true) WITH CHECK (true);
...
-- Create Announcement Interactions Table
...
CREATE TABLE IF NOT EXISTS public.event_interactions (
    ...
    student_id TEXT NOT NULL,
    action TEXT NOT NULL, -- 'view' | 'register' | 'click_link'
    timestamp TIMESTAMP WITH TIME ZONE DEFAULT timezone('utc'::text, now()) NOT NULL
);
...
CREATE POLICY "Allow public access to feature_usage_logs" ON public.feature_usage_logs FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow public access to announcement_interactions" ON public.announcement_interactions FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow public access to event_interactions" ON public.event_interactions FOR ALL USING (true) WITH CHECK (true);
